import { BarChartIcon, CircleBackslashIcon, Link1Icon } from "@radix-ui/react-icons";
import { CalendarCheck, IndianRupee, MapPin, PieChart, QrCode, Tag } from "lucide-react";
            ...
            <div className="w-full max-w-full space-y-4 mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col items-center space-y-2 border border-gray-200 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    Quickly and securely validate tickets at the entrance using
                    QR code technology.
                  </p>
                </div>
                <div className="flex flex-col items-center space-y-2 border border-gray-200 p-4 rounded-lg">
